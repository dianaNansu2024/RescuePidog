...
pygame.display.set_caption("Pathfinding with Multiple Algorithms")
...
# Main simulation loop with multiple search algorithms
def run_simulation(algorithm='dijkstra'):
    ...
    while running:
        ...
        # Simulate pathfinding towards the first survivor using the selected algorithm
        if survivors:
            goal = survivors[0]
            if algorithm == 'dijkstra':
                path = dijkstra((robot.x, robot.y), goal, robot.grid_map)
            elif algorithm == 'a_star':
                path = a_star((robot.x, robot.y), goal, robot.grid_map)
            elif algorithm == 'bfs':
                path = bfs((robot.x, robot.y), goal, robot.grid_map)
            elif algorithm == 'dfs':
                path = dfs((robot.x, robot.y), goal, robot.grid_map)
            else:
                path = []
...
# Options: 'dijkstra', 'a_star', 'bfs', 'dfs'
