...
pygame.display.set_caption("Dijkstra Pathfinding with SLAM")
...
# Main simulation loop with Dijkstra and SLAM
def run_simulation():
    ...
    while running:
        ...
        # Simulate Dijkstra's pathfinding towards the first survivor (assuming the robot goes for the first survivor)
        if survivors:
            goal = survivors[0]
